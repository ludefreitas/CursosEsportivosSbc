    ...
    <div class="popup-card popup-agenda-details-card" role="dialog" aria-modal="true" aria-labelledby="agenda-details-modal-title">
        ...
        <div class="popup-body agenda-details-modal-body">
                ...
                <div class="grid-two">
                    ...
                    <label>
                        ...
                        <select name="publico_alvo" id="agenda-special-schedule-publico">
                            ...
                            <option value="pcd"><?php echo e(condition_public_label('pcd')); ?></option>
                            <option value="pvs"><?php echo e(condition_public_label('pvs')); ?></option>
                            <option value="plm"><?php echo e(condition_public_label('plm')); ?></option>
                        </select>
                    </label>
                </div>
                <div class="grid-two">
            ...
            <form method="POST" action="<?php echo e(url('/agenda/agendar')); ?>" id="form-agendamento" class="stack-form hidden" data-ajax-form="1" data-success-reset="1">
                ...
                <label class="checkbox-line agenda-notice-acceptance" data-agenda-notice-acceptance="1"><input type="checkbox" name="aceite_edital" value="1" required><span data-agenda-notice-text="1">Li e concordo com o edital aplicável.</span></label>
