...
<div class="home-whatsapp-row">
    <span class="home-whatsapp-label">Dúvidas, sugestões e reclamações:</span>
...
<section class="section-grid">
    <article class="info-card">
        <h3>Locais e espaços</h3>
        <p>Os locais de treino podem conter vários espaços, como quadras, piscinas e salas, vinculados a modalidades terrestres ou aquáticas.</p>
    </article>
    <article class="info-card">
    ...
    <article class="info-card">
        ...
        <p>A agenda pública continua visível sem login. O acesso autenticado entra apenas quando a pessoa decide agendar ou administrar dados.</p>
    </article>
</section>
