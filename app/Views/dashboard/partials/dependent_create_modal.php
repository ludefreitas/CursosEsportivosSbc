...
<div class="popup-body admin-popup-body dashboard-dependent-modal-body">
    <div class="alert-inline">
        Cadastro restrito a moradores de São Bernardo do Campo.
    ...
    <div class="alert-inline dashboard-dependent-attention">
        Preencha CPF e data de nascimento com muita atenção. Esses dados identificam a pessoa no sistema e, se precisarem de correção depois, será necessário acionar o suporte técnico.
    </div>

    <form method="POST" action="<?php echo e(url('/dependentes/salvar')); ?>" class="stack-form dashboard-dependent-create-form" id="dashboard-dependent-create-form" data-manual-submit="1" data-external-person-form="1">
