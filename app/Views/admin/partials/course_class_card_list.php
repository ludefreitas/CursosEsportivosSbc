    ...
    <?php foreach ($courseClasses as $class) { ?>
        <article class="content-card professor-class-card admin-class-card" data-course-class-card="<?php echo e((string) $class['id']); ?>">
            ...
            <div class="professor-class-details">
                ...
                <p><button type="button" class="course-class-attendance-link" data-course-class-attendance='<?php echo e((string) json_encode($class, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES)); ?>'>Fazer Chamada</button></p>
            </div>
...
<div class="popup-overlay hidden" id="course-class-attendance-modal" aria-hidden="true"><div class="popup-card popup-admin-card class-attendance-modal-card" role="dialog" aria-modal="true"><div class="popup-head"><div><h3>Fazer chamada</h3><p class="muted" data-class-attendance-subtitle></p></div><button type="button" class="popup-close-icon" data-class-attendance-close="1" aria-label="Fechar">&times;</button></div><div class="popup-body"><div id="course-class-attendance-calendar"></div><div class="class-attendance-roster hidden" data-class-attendance-roster></div></div></div></div>
