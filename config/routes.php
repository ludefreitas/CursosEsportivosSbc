...
return [
    ...
    ['POST', '/agenda/eventos-especiais/inscrever', [AgendaController::class, 'registerSpecialEvent']],
    ...
    ['GET', '/admin/agenda-eventos-especiais/detalhe', [AdminController::class, 'specialAgendaEventDetails']],
    ...
    ['POST', '/admin/agenda-eventos-especiais', [AdminController::class, 'storeSpecialAgendaEvent']],
