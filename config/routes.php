...
return [
    ...
    ['GET', '/cursos/tokens/pendentes', [CourseEnrollmentController::class, 'pendingTokens']],
    ['POST', '/cursos/tokens/cancelar', [CourseEnrollmentController::class, 'cancelToken']],
    ...
    ['POST', '/recuperar-senha', [AuthController::class, 'recoverPassword']],
    ...
    ['GET', '/admin/pessoas/inscricoes', [AdminController::class, 'personEnrollments']],
    ...
    ['POST', '/admin/modalidades/excluir', [AdminController::class, 'deleteModality']],
    ['POST', '/admin/modalidades/cronogramas', [AdminController::class, 'storeModalitySchedule']],
    ['POST', '/admin/modalidades/cronogramas/excluir', [AdminController::class, 'deleteModalitySchedule']],
    ['POST', '/admin/modalidades/popups', [AdminController::class, 'storeModalityPopup']],
    ['POST', '/admin/modalidades/popups/excluir', [AdminController::class, 'deleteModalityPopup']],
    ...
    ['POST', '/admin/turmas/status', [AdminController::class, 'changeCourseClassStatus']],
    ['POST', '/admin/inscricoes/status', [AdminController::class, 'updateCourseEnrollmentStatus']],
    ['GET', '/admin/turmas/chamada', [AdminController::class, 'courseClassAttendance']],
    ['POST', '/admin/turmas/chamada', [AdminController::class, 'saveCourseClassAttendance']],
    ['GET', '/admin/turmas/lista-chamada.pdf', [AdminController::class, 'printableCourseClassAttendance']],
    ['GET', '/admin/turmas/lista-enderecos.pdf', [AdminController::class, 'printableCourseClassAddresses']],
    ['GET', '/admin/turmas/tokens', [AdminController::class, 'enrollmentTokens']],
    ['POST', '/admin/turmas/tokens/gerar', [AdminController::class, 'createEnrollmentToken']],
    ['POST', '/admin/turmas/tokens/excluir', [AdminController::class, 'excludeEnrollmentToken']],
    ...
    ['POST', '/admin/horarios-semanais/equipe', [AdminController::class, 'assignWeeklyScheduleTeam']],
    ...
    ['POST', '/admin/site-popups/atualizar', [AdminController::class, 'updateSitePopup']],
    ...
    ['POST', '/admin/site-popups/excluir-definitivamente', [AdminController::class, 'destroySitePopup']],
    ...
    ['POST', '/professor/minhas-turmas/excluir', [ProfessorController::class, 'deleteAssignedClass']],
    ['GET', '/professor/minhas-turmas/chamada', [ProfessorController::class, 'courseClassAttendance']],
    ['POST', '/professor/minhas-turmas/chamada', [ProfessorController::class, 'saveCourseClassAttendance']],
    ['GET', '/professor/minhas-turmas/lista-chamada.pdf', [ProfessorController::class, 'printableCourseClassAttendance']],
    ['GET', '/professor/minhas-turmas/lista-enderecos.pdf', [ProfessorController::class, 'printableCourseClassAddresses']],
    ['GET', '/professor/minhas-turmas/tokens', [ProfessorController::class, 'enrollmentTokens']],
    ['POST', '/professor/minhas-turmas/tokens/excluir', [ProfessorController::class, 'excludeEnrollmentToken']],
    ['GET', '/professor/pessoas/detalhe', [ProfessorController::class, 'personDetails']],
    ['GET', '/professor/pessoas/inscricoes', [ProfessorController::class, 'personEnrollments']],
    ...
    ['GET', '/professor/horarios-semanais/detalhe', [ProfessorController::class, 'weeklyScheduleDetails']],
    ['POST', '/professor/horarios-semanais/atualizar', [ProfessorController::class, 'updateWeeklySchedule']],
    ['POST', '/professor/horarios-semanais/inativar', [ProfessorController::class, 'deactivateWeeklySchedule']],
    ['POST', '/professor/horarios-semanais/ativar', [ProfessorController::class, 'activateWeeklySchedule']],
    ...
    ['POST', '/professor/inscricoes/token', [ProfessorController::class, 'createEnrollmentToken']],
    ['GET', '/professor/certificados/arquivo', [ProfessorController::class, 'certificateDocument']],
    ['GET', '/professor/atestados/arquivo', [ProfessorController::class, 'healthCertificateDocument']],
